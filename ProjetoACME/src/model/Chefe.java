...
public class Chefe extends Funcionario{
	...
	@Override //vai em cima do erro, vê a sugestão e add, veio automático, eclipse escreveu pra mim
	public double calcularSalario() {
		// TODO Auto-generated method stub
		return salarioBase + salarioBase*adicionalFuncao/100 + beneficioTerno; //no returno o eclipse tinha colocado zero, essa formula eu tirei das instruções do exercicio
	}
